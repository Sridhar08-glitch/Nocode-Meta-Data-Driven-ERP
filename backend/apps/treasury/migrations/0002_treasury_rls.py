"""
Enable PostgreSQL Row-Level Security on the native treasury tables (PROJECT_HANDBOOK.md §2). No-op on SQLite.
Every tenant table ships its own RLS backstop; all treasury tables are workspace-scoped.
"""
